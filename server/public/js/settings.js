(() => {
  ...
  // Autocomplete cho ô "Kênh sale" trong modal Sửa tài khoản — gợi ý theo các tên đã gõ trên
  // account khác, đỡ gõ lại/gõ lệch chính tả (vd "Linh Dương" vs "Linh Duong").
  function refreshKenhSaleDatalist() {
    const list = $('zaKenhSaleList');
    if (!list) return;
