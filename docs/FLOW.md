...
• KHÔNG chờ báo hàng gửi trước: NV thường đã báo hàng (tay) trước khi có ND ship, nên hễ XUẤT HIỆN
  ND ship là GỬI NGAY (kể cả đơn còn "Chưa báo"), không đợi lượt báo hàng -> tránh trễ ship.
